...
namespace CBGames.Objects
{
    ...
    public class MP_BaseShooterWeapon : MonoBehaviour
    {
        ...
        /// <summary>
        /// If owner will send an RPC to all networked versions to play the empty
        /// clip sound.
        /// </summary>
        ...
        /// <summary>
        /// This is called by the RPC when the networked versions receive a
        /// request from the owner for them to play a shot.
        /// </summary>
