...
namespace CBGames.Inspector
{
    ...
    public class TrackPhotonRoomNameInspector : Editor
    {
        #region Core
        GUISkin _skin = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(5);
            GUILayout.Label("Track Photon Room Name", _skin.GetStyle("Label"));
            GUILayout.Space(10);
            EditorGUILayout.HelpBox("This component requires to have a \"UICoreLogic\" somewhere in your scene.\n\n" +
                "This component will change the targeted Text to match whatever the current photon room name is.", MessageType.Info);
            #endregion
            ...
            #region Core
            DrawPropertiesExcluding(serializedObject, E_Helpers.EditorGetVariables(typeof(TrackPhotonRoomName)));
