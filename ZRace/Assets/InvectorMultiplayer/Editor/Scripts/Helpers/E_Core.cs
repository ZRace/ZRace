...
namespace CBGames.Editors
{
    ...
    {
        public static string e_t_blue_1 = string.Format("Assets{0}InvectorMultiplayer{0}Editor{0}Images{0}Window_Colors{0}blue-1.png", Path.DirectorySeparatorChar);
        public static string e_t_blue_2 = string.Format("Assets{0}InvectorMultiplayer{0}Editor{0}Images{0}Window_Colors{0}blue-2.png", Path.DirectorySeparatorChar);
        public static string e_t_blue_3 = string.Format("Assets{0}InvectorMultiplayer{0}Editor{0}Images{0}Window_Colors{0}blue-3.png", Path.DirectorySeparatorChar);
        public static string e_t_blue_4 = string.Format("Assets{0}InvectorMultiplayer{0}Editor{0}Images{0}Window_Colors{0}blue-4.png", Path.DirectorySeparatorChar);
        public static string e_t_blue_5 = string.Format("Assets{0}InvectorMultiplayer{0}Editor{0}Images{0}Window_Colors{0}blue-5.png", Path.DirectorySeparatorChar);

        public static Color e_c_blue_1 = new Color(47.1f/255f, 52.9f / 255f, 67.1f / 255f);
        public static Color e_c_blue_2 = new Color(31f / 255f, 38.4f / 255f, 55.7f / 255f);
        public static Color e_c_blue_3 = new Color(18f / 255f, 25.9f / 255f, 44.7f / 255f);
        public static Color e_c_blue_4 = new Color(8.6f / 255f, 16.1f / 255f, 33.33f / 255f);
        public static Color e_c_blue_5 = new Color(2.4f / 255f, 8.2f / 255f, 22.4f / 255f);
    }
}
#endif