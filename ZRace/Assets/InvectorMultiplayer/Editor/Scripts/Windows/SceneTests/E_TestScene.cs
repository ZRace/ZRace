    ...
    public partial class E_TestScene : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("This will scan your scene and find converted components and check them. " +
                "Then it will check converted prefabs in your \"Resources\" folder. After performing QA tests on " +
                ...
                "does not make any changes to any found objects.", _skin.textField);
