...
namespace CBGames.Inspector
{
    ...
    public class TrackSessionTypeInspector : Editor
    {
        #region Core
        GUISkin _skin = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(5);
            GUILayout.Label("Track Session Type", _skin.GetStyle("Label"));
            GUILayout.Space(10);
            EditorGUILayout.HelpBox("This component requires a \"UICoreLogic\" component somewhere in the scene. \n\n" +
                "This component will track if this room is a private or public room and modify the targeted texts to display " +
                "that information.", MessageType.Info);
            #endregion
            ...
            #region Core
            DrawPropertiesExcluding(serializedObject, E_Helpers.EditorGetVariables(typeof(TrackSessionType)));
