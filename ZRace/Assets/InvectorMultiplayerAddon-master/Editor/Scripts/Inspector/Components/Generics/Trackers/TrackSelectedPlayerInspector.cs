...
namespace CBGames.Inspector
{
    ...
    public class TrackSelectedPlayerInspector : Editor
    {
        #region Core
        GUISkin _skin = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(5);
            GUILayout.Label("Track Selected Player", _skin.GetStyle("Label"));
            GUILayout.Space(10);
            EditorGUILayout.HelpBox("This component requires to have a \"UICoreLogic\" somewhere in your scene.\n\n" +
                "This component will change the targeted Text to match whatever playerPrefab you currently have set in the NetworkManager.", MessageType.Info);
            #endregion
            ...
            #region Core
            DrawPropertiesExcluding(serializedObject, E_Helpers.EditorGetVariables(typeof(TrackSelectedPlayer)));
