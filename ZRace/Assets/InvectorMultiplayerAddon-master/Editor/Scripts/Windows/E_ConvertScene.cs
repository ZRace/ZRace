...
namespace CBGames.Editors
{
    public class E_ConvertScene : EditorWindow
    {
        ...
        {
            EditorWindow window = GetWindow<E_ConvertScene>("Convert Scene");
        ...
        private void OnEnable()
        {
            ...
            //Make window title
            this.titleContent = new GUIContent("Player Conversion", null, "Convert a objects in the scene to support multiplayer.");
