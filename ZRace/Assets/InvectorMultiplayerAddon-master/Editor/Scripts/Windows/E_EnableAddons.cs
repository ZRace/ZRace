...
namespace CBGames.Editors
{
    public class E_EnableAddons : EditorWindow
    {
        ...
        [MenuItem("CB Games/Enable Support/(Alpha) Enable FSM AI Template Add-On", false, 0)]
        ...
        private static void CB_AddonFSMAI(bool e_disable_fsm_ai = false)
        {
            if (EditorUtility.DisplayDialog("Do you have the \"FSM AI\" addon?",
                "**WARNING: This is a one way operation. Also this is \"Alpha\" code and this isn't recommend " +
                "to be used for any sort of production development. If, however, you are simply testing this out " +
                "or want to help with development then go right ahead!**\n\n" +
