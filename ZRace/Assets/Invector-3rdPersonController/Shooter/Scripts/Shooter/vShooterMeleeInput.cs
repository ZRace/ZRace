...
namespace Invector.vCharacterController
{
    ...
    public class vShooterMeleeInput : vMeleeCombatInput, vIShooterIKController, PlayerController.vILockCamera
    {
        ...
        protected override void InputHandle()
        {
            ...
            if (MeleeAttackConditions() && !_isAiming && !isReloading && !lockMeleeInput && !shooterManager.CurrentWeapon)
            {
        ...
        protected virtual void UpdateArmsIK(bool isUsingLeftHand = false)
        {
            ...
            if (targetIK != null)
            {
                ...
                if (CurrentActiveWeapon && CurrentActiveWeapon.handIKTarget && !isReloading && !cc.customAction && (cc.isGrounded || (_isAiming || _aimTimming > 0f)) && !cc.lockAnimMovement && useIkConditions)
