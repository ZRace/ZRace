...
namespace Invector.vMelee
{
    ...
    public class vCreateMeleeCharacterEditor : EditorWindow
    {
        ...
        public virtual void Create()
        {
            ...
            if (!newCharacter)
                return;          
            newCharacter.name = "vMeleeController_" + charObj.gameObject.name;
            newCharacter.AddComponent<vThirdPersonController>();
            newCharacter.AddComponent<vMeleeCombatInput>();
            ...
            newCharacter.AddComponent<vMeleeManager>();
            newCharacter.AddComponent<vLockOn>();
