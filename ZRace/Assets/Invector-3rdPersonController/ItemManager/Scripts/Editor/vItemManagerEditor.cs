...
namespace Invector.vItemManager
{
    ...
    public class vItemManagerEditor : vEditorBase
    {
        ...
        readonly string[] ignoreProperties = new string[] { "equipPoints", "applyAttributeEvents", "items", "startItems", "onStartItemUsage", "onUseItem", "onUseItemFail", "onAddItem", "onChangeItemAmount", "onDestroyItem", "onDropItem", "onOpenCloseInventory", "onEquipItem", "onUnequipItem", "onFinishEquipItem", "onFinishUnequipItem","onSaveItems","onLoadItems" };
        bool[] inEdition;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (openCloseWindow)
            {
                ...
                if (showManagerEvents)
                {
                    ...
                    if (onUseItemFail != null) EditorGUILayout.PropertyField(onUseItemFail);
                    if (onChangeItemAmount != null) EditorGUILayout.PropertyField(onChangeItemAmount);
                    if (onDropItem != null) EditorGUILayout.PropertyField(onDropItem);
                    if (onDestroyItem != null) EditorGUILayout.PropertyField(onDestroyItem);
                    ...
                    if (onFinishEquipItem != null) EditorGUILayout.PropertyField(onFinishEquipItem);
                    if (onFinishUnequipItem != null) EditorGUILayout.PropertyField(onFinishUnequipItem);
                    if (onSaveItems != null) EditorGUILayout.PropertyField(onSaveItems);
                    if (onLoadItems != null) EditorGUILayout.PropertyField(onLoadItems);
                }
                GUI.skin = skin;
                GUILayout.EndVertical();
            }
        ...
        protected virtual void ShowItemListWindow(vItem item = null)
        {
            ...
            else if (manager.itemListData.inEdition)
            {
                ...
                vItemListWindow.CreateWindow(manager.itemListData, manager.itemListData.items.IndexOf(item));
            if (item) vItemListWindow.SetCurrentSelectedItem(manager.itemListData.items.IndexOf(item));
